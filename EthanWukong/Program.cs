...
namespace Ethan_Wukong
{
    public static class Program
    {
        ...
        {
            if (Player.ChampionName != "Wukong") return;

            LoadMenu();
            defSpells();
            Game.PrintChat("Ethan's Wukong Loaded");
        ...
        private static void defSpells()
        {
            q = new Spell(SpellSlot.Q, 300);
            w = new Spell(SpellSlot.W, 0);
            e = new Spell(SpellSlot.E, 625);
            r = new Spell(SpellSlot.R, 160);
